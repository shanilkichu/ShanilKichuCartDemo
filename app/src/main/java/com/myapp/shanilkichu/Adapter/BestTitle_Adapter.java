...
public class BestTitle_Adapter extends RecyclerView.Adapter<BestTitle_Adapter.MyViewHolder> {
    Context context;
    ...
    public BestTitle_Adapter(ArrayList<ImageData> data, Context context, List<String> km, List<String> list_description,
    ...
    @NonNull
    @Override
    public BestTitle_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.best_title_item, parent, false);
        return new BestTitle_Adapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(BestTitle_Adapter.MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
