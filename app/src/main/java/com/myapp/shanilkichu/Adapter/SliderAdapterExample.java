...
public class SliderAdapterExample extends
    ...
    public void onBindViewHolder(SliderAdapterVH viewHolder, final int position) {
        ...
        viewHolder.textoriginalprice.setText("AED 600/-"); // SomeString = your old price
        viewHolder.textoriginalprice.setPaintFlags(viewHolder.textoriginalprice.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
    ...
    static class SliderAdapterVH extends SliderViewAdapter.ViewHolder {
        ...
        public SliderAdapterVH(View itemView) {
            ...
            textoriginalprice = itemView.findViewById(R.id.tv_original);
